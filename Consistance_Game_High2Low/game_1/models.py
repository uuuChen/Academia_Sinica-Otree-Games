...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        if self.round_number == 1:
            ...
            total_points = self.init_players_points('high')
            group.set_total_points_average(float(total_points / len(self.get_players())))
